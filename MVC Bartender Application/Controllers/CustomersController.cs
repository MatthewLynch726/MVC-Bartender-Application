...
namespace MVC_Bartender_Application.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ApplicationDbContex context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customers != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContex.Customers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContex.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
